...
func (m *MockStore) ListItems(arg0 context.Context) ([]db.ListItemsRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListItems", arg0)
	ret0, _ := ret[0].([]db.ListItemsRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) ListOrders(arg0 context.Context) ([]db.Order, error) {
	m.ctrl.T.Helper()
