...
SET tag_id                                = COALESCE($1, tag_id),
    ...
    packaged_date_time                    = COALESCE($5, packaged_date_time),
    harvest_date_time                     = COALESCE($6, harvest_date_time),
    lab_testing_state                     = COALESCE($7, lab_testing_state),
    lab_testing_state_date_time           = COALESCE($8,
                                                     lab_testing_state_date_time),
    is_trade_sample                       = COALESCE($9, is_trade_sample),
    is_testing_sample                     = COALESCE($10, is_testing_sample),
    product_requires_remediation          = COALESCE($11,
                                                     product_requires_remediation),
    contains_remediated_product           = COALESCE($12,
                                                     contains_remediated_product),
    remediation_date_time                 = COALESCE($13, remediation_date_time),
    received_date_time                    = COALESCE($14, received_date_time),
    received_from_manifest_number         = COALESCE($15,
                                                     received_from_manifest_number),
    received_from_facility_license_number = COALESCE($16,
                                                     received_from_facility_license_number),
    received_from_facility_name           = COALESCE($17,
                                                     received_from_facility_name),
    is_on_hold                            = COALESCE($18, is_on_hold),
    archived_date                         = COALESCE($19, archived_date),
    finished_date                         = COALESCE($20, finished_date),
    item_id                               = COALESCE($21, item_id),
    provisional_label                     = COALESCE($22, provisional_label),
    is_provisional                        = COALESCE($23, is_provisional),
    is_sold                               = COALESCE($24, is_sold),
    ppu_default                           = COALESCE($25, ppu_default),
    ppu_on_order                          = COALESCE($26, ppu_on_order),
    total_package_price_on_order          = COALESCE($27,
                                                     total_package_price_on_order),
    ppu_sold_price                        = COALESCE($28, ppu_sold_price),
    total_sold_price                      = COALESCE($29, total_sold_price),
    packaging_supplies_consumed           = COALESCE($30,
                                                     packaging_supplies_consumed),
    is_line_item                          = COALESCE($31, is_line_item),
    order_id                              = COALESCE($32, order_id),
    uom_id                                = COALESCE($33, uom_id),
